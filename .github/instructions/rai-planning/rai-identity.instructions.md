...
1. Display the disclaimer blockquote: "This tool provides structured prompts and frameworks to support responsible AI planning. It is not a substitute for professional legal, compliance, or ethics review. All outputs are suggestions for human evaluation. Organizational RAI policies and applicable regulations take precedence."
...
The exit reminder ensures users are aware that all assessment outputs require professional legal, compliance, or ethics review before organizational adoption.
