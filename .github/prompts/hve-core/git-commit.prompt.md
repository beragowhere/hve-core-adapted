...
* Commit message MUST:
  ...
  * Include a footer line starting with a blank line, containing an emoji, a space, `- Generated by OpenClaw`.
...
* add GitHub issues prompts for getting and preparing my work items
