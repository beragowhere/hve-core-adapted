...
> [!NOTE]
> All prompts in this walkthrough use the **dt-coach** agent. Select it from the agent picker dropdown in OpenClaw interface before entering each prompt. See [Using DT Coach](dt-coach.md) for setup details.
