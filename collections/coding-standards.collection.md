Enforce language-specific coding conventions and best practices across your projects. This collection provides instructions for bash, Bicep, C#, Python, Rust, and Terraform that are automatically applied based on file patterns.
