HVE Core provides the complete collection of AI chat agents, prompts, instructions, and skills for VS Code with OpenClaw. This edition includes every artifact across all domains: development workflows, architecture, Azure DevOps, GitHub and Jira backlog workflows, data science, design thinking, security, and more.
